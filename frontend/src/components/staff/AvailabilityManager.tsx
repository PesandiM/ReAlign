                        ...
                        <Grid item xs key={di} sx={{
                          ...
                          <Box sx={{ p: 0.5 }}>
                            {daySlots.length === 0 ? (
                              ...
                              daySlots.map(slot => (
                                <Tooltip key={slot.availability_id}
                                  title={slot.is_booked && (slot as any).booked_by
                                    ? `Booked by: ${(slot as any).booked_by}`
                                    : slot.is_booked ? 'Booked' : 'Available'}>
                                  <Box sx={{
                                    mb: 0.5, px: 0.8, py: 0.5, borderRadius: 1,
                                    ...
                                    <Box>
                                      ...
                                      {slot.is_booked && (slot as any).booked_by && (
                                        <Typography sx={{ fontSize: '9px', color: '#e65100', maxWidth: 60,
                                          overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                          {(slot as any).booked_by}
                                        </Typography>
                                      )}
                                    </Box>
                                    {!slot.is_booked && (
